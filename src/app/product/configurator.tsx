...
export default function Configurator({ product }: ConfiguratorProps) {
  ...
  return (
    <div className="w-full py-12">
      <div className="px-12">
        <h2 className="text-3xl font-medium pb-3 text-gray-600">{name}</h2>
          ...
          <div className="px-12 w-[500px]">
            <div className="pb-4 min-h-[65vh] justify-center flex flex-col">
              <h2 className="text-2xl  text-gray-800 pb-8 font-medium">
                Frame it right -{" "}
                <span className="text-gray-400">Your bike, your canvas.</span>
              </h2>
              <div className="grid grid-cols-5 gap-1">
                {variants?.map((variant) => (
                  <VariantSelector
                    ...
                    skus={skus}
                    variant={variant}
                    onChange={(value) => onChange({ type: "frame", value })}
                  />
                ))}
              </div>
            </div>
            <div className="py-4 min-h-[65vh]">
              <h2 className="text-2xl  text-gray-800 pb-8 font-medium">
                Time to saddle up -{" "}
                <span className="text-gray-400">your bikes throne.</span>
              </h2>
              <SaddleSelector
                saddles={currentVariant?.saddles}
                skus={skus}
                onChange={(value) => onChange({ type: "saddle", value })}
              />
            </div>
            <div className="py-4 min-h-[65vh]">
              <h2 className="text-2xl  text-gray-800 pb-8 font-medium">
                Grab life -{" "}
                <span className="text-gray-400">by the handlebars.</span>
              </h2>
            ...
            <div className="py-4 pb-24">
              <h2 className="text-2xl  text-gray-800 pb-8 font-medium">
                Pedal in style -{" "}
                <span className="text-gray-400">accessorize with a smile!</span>
              </h2>
              <AccessorySelector
                options={options}
                skus={skus}
            ...
            <div className="px-12  bg-gray-100 rounded-xl py-12 mb-96">
              <h2 className="text-2xl  text-gray-800 pb-4 font-medium">
                Done and dusted -{" "}
                <span className="text-gray-400">your bike, your way!</span>
              </h2>
              <PriceBar
                skus={skus}
                currentVariant={currentVariant}
